...
| Skill                                                                                                     | Description                                                                                                                                                    |
| --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[openloomi-memory](https://github.com/melandlabs/openloomi/tree/main/skills/openloomi-memory)**         | Search memory files, knowledge base, and chat insights. Memory search, knowledge base, documents, insights                                                     |
| **[openloomi-connectors](https://github.com/melandlabs/openloomi/tree/main/skills/openloomi-connectors)** | Manage platform integrations — OAuth connections, list accounts, check status, disconnect. Connect Telegram, WhatsApp, WeChat, Slack, Discord, Gmail, and more |
| **[openloomi-api](https://github.com/melandlabs/openloomi/tree/main/skills/openloomi-api)**               | OpenLoomi API documentation — authentication, backend routes, integrations, billing, and server-side functionality                                             |
